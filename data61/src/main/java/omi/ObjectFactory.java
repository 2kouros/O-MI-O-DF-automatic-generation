...
public class ObjectFactory {
    ...
    private final static QName _write_QNAME = new QName("omi.xsd", "write");
    /**
    ...
    * @return
    */
   @XmlElementDecl(name = "write")
    public JAXBElement<WriteRequest> createWriteRequest(WriteRequest value) {
        return new JAXBElement<WriteRequest>(_write_QNAME, WriteRequest.class, null, value);
    }
}
